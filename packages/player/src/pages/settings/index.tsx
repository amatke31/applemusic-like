                        ...
                        <Flex direction="column" gap="1">
                            {playerSettingsPages.map((page) => (
                                <SidebarButton
                                    ...
                                    label={page.label}
                                    isActive={
                                        currentPage === `player.${page.id}`
                                    }
                                    onClick={() =>
                                        setCurrentPage(`player.${page.id}`)
                                    }
                                />
                            ))}
                            ...
                            <SidebarButton
                                ...
                                isActive={
                                    currentPage === "extension.management"
                                }
                                onClick={() =>
                                    setCurrentPage("extension.management")
                                }
                            />
                            {loadedExtensions.map((extension) => {
                                ...
                                return (
                                    <SidebarButton
                                        ...
                                        label={i18n.getFixedT(null, id as any)(
                                            "name",
                                            id
                                        )}
                                        isActive={
